...
func GetFavoritesForm() gin.HandlerFunc {
	return func(c *gin.Context) {
		c.HTML(http.StatusOK, "favorites.html", nil)
	}
}
func GetPlumbingForm() gin.HandlerFunc {
	return func(c *gin.Context) {
		c.HTML(http.StatusOK, "plumbing.html", nil)
	}
}
func GetInteriorForm() gin.HandlerFunc {
	return func(c *gin.Context) {
		c.HTML(http.StatusOK, "interior.html", nil)
	}
}
func GetAccessoriesForm() gin.HandlerFunc {
	return func(c *gin.Context) {
		c.HTML(http.StatusOK, "accessories.html", nil)
	}
}
